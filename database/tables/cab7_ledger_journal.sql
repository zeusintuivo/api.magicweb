...
CREATE TABLE IF NOT EXISTS cab7_ledger_journal (
    ...
    internal_bill_number smallint(6) NOT NULL DEFAULT 0,
...
INSERT INTO cab7_ledger_journal (id, user_id, date, amount, vat_code, client_details, system_details, original_bill_number, created_at, updated_at, deleted_at)
